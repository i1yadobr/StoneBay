...
#define CHOOSE_GAMEMODE_RESTART     3 // The gamemode could not be chosen; we will restart the server.
#define CHOOSE_GAMEMODE_SILENT_REDO 4 // The gamemode could not be chosen; we request to have the the proc rerun on the next tick.
...
#define DEBUG_TELECRYSTAL_AMOUNT 999
