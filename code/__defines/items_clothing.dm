...
var/list/default_onmob_icons = list(
		...
		slot_wear_id_str = 'icons/inv_slots/misc/id.dmi',
		...
		slot_handcuffed_str = 'icons/inv_slots/misc/handcuffs.dmi',
		slot_legcuffed_str = 'icons/inv_slots/misc/handcuffs.dmi',
		slot_gloves_str = 'icons/inv_slots/gloves/mob.dmi',
		slot_s_store_str = 'icons/inv_slots/suitstorage/mob.dmi',
		slot_tie_str = 'icons/inv_slots/accessories/mob.dmi',
