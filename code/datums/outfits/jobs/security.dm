...
/decl/hierarchy/outfit/job/security/hos
	name = OUTFIT_JOB_NAME("Директор милиции")
	l_ear = /obj/item/device/radio/headset/heads/hos
	uniform = /obj/item/clothing/under/soviet/tcc
	id_type = /obj/item/card/id/security/head
	pda_type = /obj/item/device/pda/heads/hos
	backpack_contents = list(/obj/item/handcuffs = 1)

/decl/hierarchy/outfit/job/security/warden
	name = OUTFIT_JOB_NAME("Комендант")
...
/decl/hierarchy/outfit/job/security/detective
	name = OUTFIT_JOB_NAME("Оператор КГБ")
	head = /obj/item/clothing/head/ushanka/tcc
	uniform = /obj/item/clothing/under/suit_jacket/charcoal
	suit = /obj/item/clothing/suit/storage/toggle/leathercoat
...
/decl/hierarchy/outfit/job/security/detective/forensic
	name = OUTFIT_JOB_NAME("Следователь")
	head = null
	suit = /obj/item/clothing/suit/storage/toggle/forensics/blue

/decl/hierarchy/outfit/job/security/officer
	name = OUTFIT_JOB_NAME("Милиционер")
	uniform = /obj/item/clothing/under/gorka
	l_pocket = /obj/item/device/flash
