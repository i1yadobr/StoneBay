...
/datum/god_form/narsie
	...
	<b>Benefits:</b><br>
		+Can gain power from blood sacrifices.<br>
...
/datum/god_form/narsie/take_charge(mob/living/user, charge)
	...
	if(prob(charge))
		to_chat(user, SPAN("warning", "You feel drained..."))
...
/datum/god_form/wizard
	...
	<b>Benefits:</b><br>
		+Learn spells from two different schools.<br>
		+Deity gains power through each spell use.<br>
	<b>Drawbacks:</b><br>
