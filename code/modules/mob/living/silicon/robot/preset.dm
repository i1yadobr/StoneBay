...
var/global/list/glob_qualified_doctor_actions = list(/datum/action/cooldown/say/standart_medbot,
...
/mob/living/silicon/robot/qualified_doctor/Initialize()
	..()
	action_spells = glob_qualified_doctor_actions
