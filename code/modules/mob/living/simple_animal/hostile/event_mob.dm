var/global/list/glob_slug_spells = list(/datum/spell/toggled/transform, /datum/spell/toggled/thermal, /datum/spell/toggled/sting_paralize)
...
/mob/living/simple_animal/hostile/slug
	...
	var/list/wizardy_spells

/mob/living/simple_animal/hostile/slug/Initialize()
    . = ..()
    wizardy_spells = glob_slug_spells
...
var/global/list/glob_worm_spells = list(/datum/spell/targeted/pumping_out_blood, /datum/spell/toggled/thermal, /datum/spell/targeted/heal_slug, /datum/spell/aoe_turf/conjure/slug)
...
/mob/living/simple_animal/hostile/slug/worm/Initialize()
    . = ..()
    wizardy_spells = glob_worm_spells
