...
/obj/item/shreddedp/proc/burnpaper(obj/item/flame/lighter/P, mob/user)
	...
	user.visible_message(SPAN("danger", "\The [user] burns right through \the [src], turning it to ash. It flutters through the air before settling on the floor in a heap."), \
		SPAN("danger", "You burn right through \the [src], turning it to ash. It flutters through the air before settling on the floor in a heap."))
	FireBurn()
