...
/obj/item/gun/projectile/revolver/detective/m2019/Destroy()
	QDEL_NULL(bcell)
	return ..()
...
/obj/item/gun/projectile/revolver/detective/m2019/examine(mob/user, infix)
	. = ..()
...
/obj/item/gun/projectile/revolver/detective/m2019/on_update_icon()
	..()
	if(loaded.len)
