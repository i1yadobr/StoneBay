/obj/item/gun/launcher/money
	...
	description_info = "Load money into the cannon by picking it up with the gun, or feeding it directly by hand. \
	Use in your hand to configure how much money you want to fire per shot."
	description_fluff = "These devices were invented several centuries ago and are a distinctly human cultural infection. \
	...
	description_antag = "Sliding a cryptographic sequencer into the receptacle will short the motors and override their speed. \
	If you set the cannon to dispense 100 credits or more, this might make a handy weapon."
