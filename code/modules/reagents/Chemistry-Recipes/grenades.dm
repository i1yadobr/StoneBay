...
/datum/chemical_reaction/emp_pulse/on_reaction(datum/reagents/holder, created_volume)
	...
	empulse(location, round(created_volume / 240), round(created_volume / 140), 1)
...
/datum/chemical_reaction/napalm/on_reaction(datum/reagents/holder, created_volume)
	...
	for(var/turf/simulated/floor/target_tile in range(0,location))
		target_tile.assume_gas("plasma", created_volume * 0.25, 400 CELSIUS)
...
/datum/chemical_reaction/chemsmoke/on_reaction(datum/reagents/holder, created_volume)
	...
	S.attach(location)
	S.set_up(holder, created_volume * 0.25, 0, location)
...
/datum/chemical_reaction/foam/on_reaction(datum/reagents/holder, created_volume)
	...
	for(var/mob/M in viewers(5, location))
		to_chat(M, SPAN("warning", "The solution spews out foam!"))
...
/datum/chemical_reaction/metalfoam/on_reaction(datum/reagents/holder, created_volume)
	...
	for(var/mob/M in viewers(5, location))
		to_chat(M, SPAN("warning", "The solution spews out a metalic foam!"))
