...
/obj/item/reagent_containers/spray/attack_self(mob/user)
	...
	to_chat(user, SPAN("notice", "You adjusted the pressure nozzle. You'll now use [amount_per_transfer_from_this] ml per spray."))
...
/obj/item/reagent_containers/spray/verb/empty()
	...
	if (alert(usr, "Are you sure you want to empty that?", "Empty Bottle:", "Yes", "No") != "Yes")
		return
	if(isturf(usr.loc))
		to_chat(usr, SPAN("notice", "You empty \the [src] onto the floor."))
