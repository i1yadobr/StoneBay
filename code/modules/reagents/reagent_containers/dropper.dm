...
/obj/item/reagent_containers/dropper/afterattack(obj/target, mob/user, proximity)
	...
	if(reagents.total_volume)
		...
		if(ismob(target))
			...
			trans = reagents.trans_to(target, amount_per_transfer_from_this) //sprinkling reagents on generic non-mobs. Droppers are very precise
			to_chat(user, SPAN("notice", "You transfer [trans] ml of the solution."))
		...
		to_chat(user, SPAN("notice", "You fill the dropper with [trans] ml of the solution."))
