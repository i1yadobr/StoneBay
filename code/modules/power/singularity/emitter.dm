...
/obj/machinery/power/emitter
	...
	description_info = "You must secure this in place with a wrench and weld it to the floor before using it. \
	The emitter will only fire if it is installed above a cable endpoint. Clicking will toggle it on and off, \
	at which point, so long as it remains powered, it will fire in a single direction in bursts of four."
	description_fluff = "Lasers like this one have been in use for ages, in applications such as mining, \
	cutting, and in the startup sequence of many advanced space station and starship engines."
