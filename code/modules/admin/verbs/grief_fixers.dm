/client/proc/fixatmos()
	...
	to_world(SPAN("danger", "Initiating restart of atmosphere. The server may lag a bit."))
	sleep(10)
	...
	for(var/datum/pipe_network/PN in SSmachines.machinery)
	...
	to_world(SPAN("danger", "Atmosphere restart completed in <b>[(world.timeofday - current_time)/10]</b> seconds."))
