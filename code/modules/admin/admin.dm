	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='byond://?src=\ref[src];simplemake=human;species=Tajara;mob=\ref[M]'>Tajaran</A>
				<A href='byond://?src=\ref[src];simplemake=human;species=Skrell;mob=\ref[M]'>Skrell</A>
				<A href='byond://?src=\ref[src];simplemake=human;species=Trottine;mob=\ref[M]'>Trottine</A>
...
/datum/admins/proc/show_game_mode()
	...
	out += "<b>Shuttle delay multiplier:</b> <a href='byond://?src=\ref[SSticker.mode];set=shuttle_delay_mult'>[SSticker.mode.shuttle_delay_mult]</a><br/>"
