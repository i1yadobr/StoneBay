...
/atom/proc/visible_message(message, blind_message, range = world.view, check_ghosts = null)
...
/atom/proc/audible_message(message, deaf_message, hearing_distance = world.view, check_ghosts = null, splash_override = null)
