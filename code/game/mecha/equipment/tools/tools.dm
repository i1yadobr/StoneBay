...
/obj/item/mecha_parts/mecha_equipment/servo_accelerator/get_equip_info()
	if(!chassis)
		return
	return "<span style=\"color:[equip_ready? "#0f0" : "#f00"];\">*</span>&nbsp;[src.name] - <a href='byond://?src=\ref[src];toggle_accelerator=1'>[equip_ready?"Dea":"A"]ctivate</a> (<a href='byond://?src=\ref[src];toggle_turbo=1'><span style=\"color:[turbo_mode? "#f00" : "#0f0"];\">TURBO</span></a>)"
