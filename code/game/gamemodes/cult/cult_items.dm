...
/obj/item/melee/cultblade/attack(mob/living/M, mob/living/user, target_zone)
	...
	if(affecting)
		to_chat(user, SPAN("danger", "An unexplicable force rips through your [affecting.name], tearing the sword from your grasp!"))
	else
		to_chat(user, SPAN("danger", "An unexplicable force rips through you, tearing the sword from your grasp!"))
