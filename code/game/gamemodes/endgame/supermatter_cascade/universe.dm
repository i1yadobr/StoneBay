...
/datum/universal_state/supermatter_cascade/OnShuttleCall(mob/user)
	if(user)
		to_chat(user, SPAN("sinister", "All you hear on the frequency is static and panicked screaming. There will be no shuttle call today."))
	return 0
...
/datum/universal_state/supermatter_cascade/OnEnter()
	set background = 1
	to_world(SPAN("sinister", "<font style='font-size:22pt'>You are blinded by a brilliant flash of energy.</font>"))
