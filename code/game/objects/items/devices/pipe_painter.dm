/obj/item/device/pipe_painter
	...
	description_fluff = "Though by no means a modern miracle, synthesized pigments have revolutionized the electrical engineering industry, \
	making time-consuming painting and color coding jobs an effortless non-issue."
