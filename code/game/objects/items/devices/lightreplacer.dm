...
/obj/item/device/lightreplacer
	...
	description_antag = "Using a cryptographic sequencer on this device will cause it to overload each light it replaces; \
	when turned on, the new lights will explode!"
