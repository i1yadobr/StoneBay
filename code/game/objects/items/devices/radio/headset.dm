...
/obj/item/device/radio/headset/headset_mining
	...
	desc = "A headset used by the shaft miners."
	icon_state = "mine_headset"
	item_state = "mine_headset"
	ks2type = /obj/item/device/encryptionkey/headset_cargo

/obj/item/device/radio/headset/headset_mining/ToggleBroadcast()
	. = ..()
	update_icon()

/obj/item/device/radio/headset/headset_mining/on_update_icon()
	ClearOverlays()
	if(broadcasting)
		AddOverlays("headset_up")
...
// TODO: Sprite cool icon for them
