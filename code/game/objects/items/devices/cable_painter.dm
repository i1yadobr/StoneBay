/obj/item/device/cable_painter
	...
	description_info = "Use this device to select a preferred cable color. Apply it to a bundle of cables on your person, \
	or use it on installed cabling on the floor to paint it in your chosen color."
	description_fluff = "A device often used by spacefaring engineers to color-code their electrical systems. \
