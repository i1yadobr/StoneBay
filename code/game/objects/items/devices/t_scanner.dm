...
/obj/item/device/t_scanner
	...
	description_info = "Use this to toggle its scanning capabilities on and off. While on, \
	it will expose the layout of cabling and pipework in a 3x3 area around you."
	description_fluff = "The T-ray scanner is a modern spectroscopy solution and labor-saving device. \
