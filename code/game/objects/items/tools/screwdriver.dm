...
/obj/item/screwdriver
	...
	description_info = "This tool is used to expose or safely hide away cabling. It can open and shut the maintenance panels on vending machines, airlocks, \
	and much more. You can also use it, in combination with a crowbar, to install or remove windows."
	...
	description_antag = "In the world of breaking and entering, tools like multitools and wirecutters are the bread; the screwdriver is the butter. \
