...
/obj/item/melee/energy/sword/saber
	...
	description_antag = "The energy saber is a very strong melee weapon, capable of severing limbs easily if they are targeted. \
	It is also capable of to block projectiles and melee attacks while it is being used easily deflecting. \
...
/obj/item/melee/energy/sword/dualsaber/on_update_icon()
	...
	AL_LAZYSET(item_state_slots, slot_l_hand_str, new_item_state)
	AL_LAZYSET(item_state_slots, slot_r_hand_str, new_item_state)
