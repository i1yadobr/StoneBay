...
/obj/machinery/telecomms/relay/Options_Menu()
	var/dat = ""
	if(src.z == TELECOMM_Z)
		dat += "<br>Signal Locked to the [station_name()]: <A href='byond://?src=\ref[src];change_listening=1'>[listening_levels == GLOB.using_map.get_levels_with_trait(ZTRAIT_CONTACT) ? "TRUE" : "FALSE"]</a>"
