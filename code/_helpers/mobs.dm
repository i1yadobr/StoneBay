...
/proc/do_mob(atom/movable/affecter, mob/target, time = 30, target_zone = 0, uninterruptible = 0, progress = 1, incapacitation_flags = INCAPACITATION_DEFAULT, datum/callback/extra_checks)
	if(!affecter || !target)
		return FALSE
