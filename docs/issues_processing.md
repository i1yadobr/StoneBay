...
1. **Оценка приоритета (только для StoneBay Owner, главы разработки и глав серверов).** Если все очень плохо - наивысший приоритет. Если игроки сталкиваются с этим каждый день и баг мешает каким-то основным механикам - повышенный приоритет, если мелочь, типо цвет галстука поменять, то пониженный.
...
**Этот этап касается только улучшений.** Сюда все улучшения попадают если модератор, StoneBay Owner или разработчик считают, что по иссую есть вопросы. Эти вопросы обязательно должны быть заданы в комментариях!
...
* [Призраки на фотографиях #1166](https://github.com/ChaoticOnyx/StoneBay/issues/1166) - залезть в код фотоаппарата и немного подкрутить проверки на инвиз. Уникальная задача, как это делать подсмотреть негде, поэтому не простой, а обычный.
* [Крысы разносят вирусы #1031](https://github.com/ChaoticOnyx/StoneBay/issues/1031) - объединить механику мышей с их укусами и вирусов.
* [Хил для священника #1123](https://github.com/ChaoticOnyx/StoneBay/issues/1123) - запихать в священника немного функционала их медицины. Медицина - неоч простая штука, поэтому не простой, а средний.
...
* [Вернуть классическую базу данных СБ #1020](https://github.com/ChaoticOnyx/StoneBay/issues/1020) - скопипастить код из старого билда, интегрировать в новый код программ
* [Революция: захват областей #975](https://github.com/ChaoticOnyx/StoneBay/issues/975) - новая механика
* [Механика варнингов #1247](https://github.com/ChaoticOnyx/StoneBay/issues/1247) - новая механика
* [Рефакторинг /decl/observ/proc/raise_event #1953](https://github.com/ChaoticOnyx/StoneBay/issues/1953) - оптимизация системы ивентов, которая много где используется и требует аккуратности
...
* [Возможность автоджоббана для АВД #997](https://github.com/ChaoticOnyx/StoneBay/issues/997) - новая механика, работа с БД, пилить сложные формы, интерфейсы пилить. Тут мб даже имело смысл обновить сложность до нереальной, т.к. слишком много всего.
