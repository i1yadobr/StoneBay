> [!NOTE]  
> Данный гайд унаследован от проекта [OnyxBay команды ChaoticOnyx](https://github.com/ChaoticOnyx/OnyxBay/) и ещё не был пересмотрен под условия StoneBay.  
...
**[Процесс работы с иссуями](https://github.com/ChaoticOnyx/StoneBay/blob/dev/docs/issues_processing.md)** - гайд по иссуям и плашкам в нашем репозитории.
...
4. Переменные среды, формат записи: `StoneBay__KEY__VALUE`.
...
- **Аппрув StoneBay owner-а.** Если в Pull Request есть изменения игровой логики, то он должен быть аппрувнут StoneBay Owner-ом. Аппрув не нужен, если Pull Request выполнен в рамках иссуя, который был ранее аппрувнут StoneBay Owner-ом. Также аппрув не нужен для фикса багов и любых изменений, которые не затрагивают игровой опыт игроков (рефакторинг, оптимизации, фичи для администраторов и подобное).
