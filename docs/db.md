...
В билде StoneBay используется MariaDB. Хосты и разработчики могут выбрать любую другую совместимую БД путём редактирования докер-файла или просто запуска своей БД по вкусу и применения схемы из папки tools/sql/schema.
